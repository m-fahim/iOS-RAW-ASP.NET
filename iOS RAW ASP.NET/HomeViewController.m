...
- (void)viewDidLoad
{
    ...
    //[request addValue:[NSString stringWithFormat:@"Bearer %@", savedToken] forHTTPHeaderField:@"Authorization "];
    ...
    if (result != nil)
    {
        ...
        if(resSrt)
        {
            ...
            @catch (NSException * e) {
                ...
                ViewController *lvc = (ViewController *)[ self.storyboard instantiateViewControllerWithIdentifier:@"loginViewController"];
